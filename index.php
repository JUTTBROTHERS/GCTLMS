...
<head>
  ...
  <title>Student Grading GCT Kamalia</title>
...
<body>
  ...
  <section id="hero" class="d-flex justify-content-center align-items-center" style="background-image: url('assets/img/phb.jpg');">
    <div class="container position-relative" data-aos="zoom-in" data-aos-delay="100">
      <h1>Student Grading System<br>GCT Kamalia</h1>
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Our Mission</h2><!-- Log on to juttgjuttofficial.com for more projects! -->
          <p>Our Mission</p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
            <p>
			<!-- Log on to juttgjuttofficial.com for more projects! -->
            He Is the Best College In our City, He Is Begest And Toped Class Platform.To Check Techniacal Education.
  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              Stop No 3 GCT Kamalia,<br>
              Punjab, Pakistan<br><br>
              <strong>Phone:</strong> +92-346-4922198,<br>
              <strong>Email:</strong> mushifmujtaba786@gmail.com<br>
            </p>
          </div>
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="mr-md-auto text-center text-md-left">
        <div class="copyright">
          &copy; <strong><span>Student Grading System</span></strong> - <?php echo date('Y');?> - Developed By Mushif Jutt
        </div>
        <div class="credits">
